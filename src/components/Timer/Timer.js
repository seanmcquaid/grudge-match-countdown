...
const Timer = props => {
    ...
    const afterGameTimeContent = <iframe className={styles.youtubeVideo} title="Grudge Match Video" src="https://www.youtube.com/embed/BRo7v3VTz7g" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>;
